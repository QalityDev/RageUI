-- ====================================================================
-- Exemple de Menu RageUI Officiel FlashBack Mihara avec Emojis
...
CreateThread(function()
    while true do
        ...
        -- Sous-Menu "Gestion du Monde" (Identique à l'image du serveur avec Emojis)
        RageUI.IsVisible("AdminWorldMenu", function()
            -- Boutons désactivés (Affichent le cadenas 🔒 comme dans l'image)
            RageUI.Button("☀️ Météo", "Gérer la météo globale", {}, false, {})
            ...
            RageUI.Button("🏝️ Activer l'alarme de Cayo Perico", "Déclencher l'alarme de l'île", {}, true, {})
        end)
    end
end)
